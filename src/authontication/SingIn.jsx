    ...
    <div className="flex md:flex-row flex-col">
      ...
      <div className="flex-1 my-auto">
        <div className="max-w-[1920px] mx-auto md:w-[85%] pb-10">
          <div className=" rounded-xl lg:shadow mt-10 w-[80%] bg-[#FAFAFA] mx-auto">
                ...
                <div>
                  ...
                  <form onSubmit={handleSignIn} className="space-y-3 mt-4 w-full ">
                    <div>
                      <fieldset className="border bg-white border-solid border-gray-300 p-2 w-full rounded">
                        ...
                        <input
                          ...
                          className="text-sm pt-1 w-full placeholder:text-black text-black focus:outline-0"
                        />
                      </fieldset>
                    </div>
                    <div>
                    ...
                    <div className="flex justify-end">
                        <p className="text-[#1E99F5] text-sm">Forgot Password</p>
                    </div>

                    <div className="flex gap-3 -mt-2 text-black">
                        <input type="checkbox" className="input-accent" name="check" id="check" />
                          <label htmlFor="check" className="text-sm">I agree to the <span className="underline">Terms & Policy</span></label>
                    </div>
                    ...
                    <div className="  border-b text-center">
                      <div className="leading-none text-black px-2 inline-block text-base bg-white tracking-wide font-medium  transform translate-y-3/4">
                        or 
                      </div>
                    </div>
                  </form>
                  ...
                  <div className="text-black/90 text-center font-semibold text-base">
                  Have an account?
                    <Link
                      to="/singUp"
      ...
      <div className="flex-1 bg-[#020306] relative h-fit">
        ...
        <div className="absolute  text-xs top-1/2 left-1/2 -translate-y-1/2 text-center -translate-x-1/2 text-white">
          <img className="mx-auto w-[40%] mb-1 " src={logo} alt="" />
