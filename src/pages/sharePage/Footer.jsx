...
const Footer = () => {
  return (
    <footer className="bg-[#0E0E0E]">
      <div className="pt-20 max-w-[1440px] mx-auto lg:w-[85%]">
        <div className="footer text-base-content pb-24 border-b border-[#252948]">
          ...
          <nav className="text-lg">
            <h6 className="text-white font-semibold mb-4">Community & Support</h6>
        ...
        <div>
          ...
          <p className="text-center text-[#323544] font-semibold pb-8 mt-11">EEVE © 2024. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
